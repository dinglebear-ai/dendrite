...
project_repo=${ARTIFACT_PROJECT:?Set ARTIFACT_PROJECT to the project checkout}
# companion_repo=[absolute-companion-checkout-if-needed]
...
require_text 'pattern' '[project/source/path]' 'claim 1 — [what a PASS proves]'

# --- Claim 2: [state the claim] ----------------------------------------------
require_absent 'pattern' '[project/source/path]' 'claim 2 — [what a PASS proves]'
